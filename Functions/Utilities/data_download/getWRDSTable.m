...
% getWRDSTable(WRDS,'CRSP','MSF',...
%                   [Params.directory,'Data',filesep, 'CRSP', filesep]);   % Downloads the CRSP monthly stock file (MSF) table from WRDS and stores it as CRSP_MSF.csv in the selected directory
% getWRDSTable(WRDS,'CRSP','MSF',,...
%              [Params.directory,'Data',filesep, 'CRSP', filesep], ...          
%              'customQuery', ['select permno, ret, date from CRSP.MSF']); % Downloads and stores the selected query from WRDS and stores it as CRSP_MSF.csv in the selected directory
