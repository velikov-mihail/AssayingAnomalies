...
% PURPOSE: This function calculates cumulative returns for momentum 
% variables
%------------------------------------------------------------------------------------------
% USAGE:   
...
%        -from - starting lag for cumulative returns (including this month)                               
%        -to - end lag for cumulative returns (excluding this month)                             
%------------------------------------------------------------------------------------------
% Output:
...
if from-to==1
    ...
    % Use log returns for quicker calculations
    tret = log(1 + ret);
    if to == 0
        RR = tret;
    else
