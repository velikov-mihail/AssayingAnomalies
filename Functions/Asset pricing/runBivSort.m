...
for i=1:nPtf2
    ...
    thisShortInd=i;
    longShortCondStrats=[longShortCondStrats Res.pret(:,thisLongInd)-Res.pret(:,thisShortInd)];
end
CondRes=estFactorRegs(longShortCondStrats,Res.dates,p.Results.factorModel,'addLongShort',0,'inputIsExcessRets',1);
...
CondRes(2,1)=estFactorRegs(longShortCondStrats,Res.dates,p.Results.factorModel,'addLongShort',0,'inputIsExcessRets',1);
