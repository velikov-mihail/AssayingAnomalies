...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% quality control, use SIC = [0:9997]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% more quality control, SIC = [0:9997]'
...
% four codes
% 900   Fishing, hunting and trapping -- 11 obs
% 3990  Misc. manuf. indus.           -- 570 obs
% 9995  Non-operating establishments  -- 1433 obs
% 9997  Industrial conglomerates      -- 287 obs

% ok to drop 9995. What about the others?
...
FF49Names=array2table(FF49Names);
FF49Names.Properties.VariableNames={'number','shortName','longName'};
